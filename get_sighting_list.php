...
$where_clause = "";
$sql = "";
$sql = "SELECT l1.id,s.common_name,l.location_name,l.city,st.state,u.user_name,l1.sighting_date,l1.obs_type,";
...
$sql .= $where_clause . " order by l1.id DESC";
...
$i=0;
	  ...
	  if($i == '0') {
	  	echo "<h1>" . $line{'location_name'} . ", ".$line{'city'}.", ".$line{'state'} . "</h1>";
	  }
              echo "<li><a target='_blank' href='sighting.php?id=" . $line['id'] . "' title='Click here to go to the sighting page'>" . $line['user_name'] . " - " . date("d M Y",strtotime($line{'sighting_date'})) . " - " .  $line['obs_type'] . " sighting - " . $line['common_name']  . "</a></li>";
          $i++;
