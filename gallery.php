...
$base_url="http://migrantwatch.in/gallery.php?" . $gurl;
...
if($cur_page == 1 ) {  $cur_page_start = 0; } else { $cur_page_start = ($cur_page-1)  * 16; }
...
while ($line = mysql_fetch_array($result_final)) {
	//list($name,$ext) = explode('\.',$line["photo_filename"]);
	...
	if ($n==0 or $n==4) { 
        	$n=0 ; 
        	print "</tr><tr>"; 
        	print "<td style='text-align:center;padding-bottom:20px;'> <a href=\"photo.php?id=$photo_id&$get_url\"><img style='border:solid 5px #c0c0c0;' title='' src='image_uploads/metn_" .  $line["photo_filename"] . "' title='" . $line['photo_caption'] . "'></a> <br>";
		print "<small>" .  stripslashes($line["user_name"]) . "</small>";
        	print "</td>";
	} else {
        	print "<td style='text-align:center;padding-bottom:20px;'> <a href=\"photo.php?id=$photo_id&$get_url\"><img style='border:solid 5px #c0c0c0;' title='" . $line['photo_caption'] . "'";
		print ' src="image_uploads/metn_' . $line["photo_filename"] . '"></a><br>';
		print "<small>" . stripslashes($line["user_name"]) . "</small>"; 
        	print "</td>";
	}
