...
<?
include("query_reports2.php");
				
$where_clause2 = " AND s.Active = '1' order by l.latitude,l.longitude DESC LIMIT 6000";
	        ...
	        while ($line = mysql_fetch_array($result, MYSQL_ASSOC)) {
                ...
                if($line['latitude']) {
                   if(($lat == $oldlat) && ($lng == $oldlng)) {
                        ...
                        echo "var point = new google.maps.LatLng(" . $line['latitude'] . "," . $line['longitude'] .");\n";
?>
...
<div class='container' style="width:930px;margin-left:auto;margin-right:auto;border-top:solid 1px #d95c15" id='tab-set'>
   ...
   <div id='text1'>
              <div id="map" style="width:930px;height:700px;">Loading maps. This might take some time</div><br><br>
  </div>
