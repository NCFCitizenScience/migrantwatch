...
<div class='container first_image'>
     <div class='cms page_layout' style='padding-top:10px'><?php
	      ...
	      $string = "<div class='notice'>Thank you registering with MigrantWatch. A confirmation email has been sent to your email address. Please confirm to proceed further</div>";
	      echo  $string;
